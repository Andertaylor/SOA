...
export default class ClotheslinePage extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      data: [
        { id: 1, title: "Subir tendedero", color: colors.gray},
        { id: 2, title: "Abrir tendedero", color: colors.lightblue},
        { id: 3, title: "Bajar tendedero", color: colors.lightblue},
        { id: 4, title: "Cerrar tendedero", color: colors.gray}
      ],   
